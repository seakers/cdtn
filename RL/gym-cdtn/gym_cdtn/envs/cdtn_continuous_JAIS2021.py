...
class CdtnEnvContinuous(gym.Env):
    ...
    def __init__(self):
        ...
        config_file = './RL/gym-cdtn/inputs/lunar_scenario4.yaml'
        ...
        # The action space includes 7 different types of actions that the intelligent
